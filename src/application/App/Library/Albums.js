...
const {COVER_FOLDER, COVER_DEFAULT} = mediaLibrary
...
export default inject(({appStore}) => ({
  library: appStore.library,
  playAlbum: appStore.playAlbum,
  albumPlaying: appStore.albumPlaying,
  addAlbumToPlaylist: appStore.addAlbumToPlaylist
}))(observer(Albums))
